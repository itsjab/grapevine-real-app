        ...
        content: [
          ...
          },
          {
            ...
            text: `
              ...
              3. When mentioning other grape varieties, wrap them in a link with the following format: [Variety Name](/dashboard/guides/varieties/variety-name). For example: [Chardonnay](/dashboard/guides/varieties/chardonnay). Do not wrap the main grape variety you are writing about in a link.
